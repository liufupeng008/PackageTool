...
# _projectPath = BasePath + '/zbcq-client_version/CocosLuaGame/'
# PluginConfig = _projectPath + 'frameworks/runtime-src/proj.ios_mac/' + '/ios/PluginConfig.xml'
# ChannelSdk = 'tiantuo_yxm'
# channelNo='5062'
...
zbprojectInfo_dict = {
    'tiantuo_yxm': {
                ...
                'info':{
                        ...
                        '5070': {'displayName': '荣耀传奇',
                                 ...
                                 'ios_hd': 'ios_hd135',
                                 'yxm_gameId': 'xingtuo_rongyaochuanqiLS_1',
                                 'urlsechems': 'com.yxm.rongyaochuanqiLS',
                                 'TIANTUOAPPID': '100961'},
    ...
    'tiantuo_99you': {
        'targetName': 'tiantuo_99you',
        'info': {
                '12030': {'displayName': '雷霆战神',
                          'bundleid': 'com.ltzs.jjyx',
                          'ios_hd': 'ios_hd117',
                          'urlsechems': 'Tracelesscom.ltzs.jjyx',
                          'TIANTUOAPPID': '100216'}}
    },
    'xianfeng': {
        'targetName': 'xianfeng',
        'info': {
            '4056': {'displayName': '血饮狂刀',
                      'bundleid': 'mu09ugjs.xykd',
                      'ios_hd': 'ios_hd128',
                      'urlsechems': 'mu09ugjs.xykd',
                      },
            '4057': {'displayName': '嗜魂传说',
